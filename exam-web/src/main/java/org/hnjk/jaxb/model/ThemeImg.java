...
public class ThemeImg {
	
	String bigThemeImgPath;
	String middleThemeImgPath;
	String smallThemeImgPath;
	...
	public String getMiddleThemeImgPath() {
		return middleThemeImgPath;
	}
	public void setMiddleThemeImgPath(String middleThemeImgPath) {
		this.middleThemeImgPath = middleThemeImgPath;
	}
